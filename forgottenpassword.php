...
<body>
	...
	<form action="signup.php" method="post">
			...
			<div class="n2"><center>Reset password</center></div><br>
			<div class="n1">Parent registred ph.no</div>
			<input type="tel" name="name1" id="m124"><br>
			<div class="n1">New Password</div><input type="password" name="pas1" id="m124">
			<div class="n1">Confirm Password</div><input type="password" name="pas2" id="m124">
